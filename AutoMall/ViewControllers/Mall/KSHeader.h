...
//红色
#define RRGB ([UIColor colorWithRed:234/255.0 green:33/255.0 blue:45/255.0 alpha:1])
//灰色
#define GRGB ([UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1])
#endif /* Header_h */
