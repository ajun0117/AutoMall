...
- (NSArray *)multiTablesView:(MultiTablesView *)multiTablesView sectionIndexTitlesAtLevel:(NSInteger)level;
...
@property (nonatomic, assign)  id<MultiTablesViewDataSource> dataSource;
@property (nonatomic, assign)  id<MultiTablesViewDelegate> delegate;
